...
class FactTests: XCTestCase {
    ...
    func testEquatable() {
        let fact1 = Fact(id:53, text:"testText", type:"testType", resource: "testResource")
        let fact2 = Fact(id:53, text:"testText", type:"testType", resource: "testResource")
        let fact3 = Fact(id:53, text:"testTextDifferent", type:"testType", resource: "testResource")
