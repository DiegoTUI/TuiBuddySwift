...
class AttractionManagerTests: XCTestCase {
    ...
    func testReadAttractions() {
        ...
        XCTAssertEqual(attraction1.facts[0].id, "factId_1_1", "wrong id for fact1 attraction1")
        ...
        XCTAssertEqual(attraction1.facts[1].id, "factId_1_2", "wrong id for fact2 attraction1")
        ...
        XCTAssertEqual(attraction1.facts[2].id, "factId_1_3", "wrong id for fact3 attraction1")
        ...
        XCTAssertEqual(attraction2.facts[0].id, "factId_2_1", "wrong id for fact1 attraction2")
        ...
        XCTAssertEqual(attraction2.facts[1].id, "factId_2_2", "wrong id for fact2 attraction2")
