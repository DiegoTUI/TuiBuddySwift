...
class NotificationManager {
    ...
    private class var _notifications: Dictionary<Int32, Bool> {
        get {
            return _private_struct.notifications
        }
        set {
            _private_struct.notifications = newValue
        }
    }
    
    public class var _scheduleLocalNotification: (UILocalNotification) -> Void {
        get {
            return _private_struct.scheduleLocalNotification
        }
        set {
            _private_struct.scheduleLocalNotification = newValue
        }
    }
    ...
    class func sendLocalNotificationForAttraction(attraction: Attraction, withMessage message: String) {
        ...
        if _notifications[attraction.id] == nil || _notifications[attraction.id]! == false {
            ...
            _notifications[attraction.id] = true
